...
https://github.com/laoreja/HPLFlowNet/blob/master/datasets/kitti.py
"""
...
class KITTI(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        voxel_list = np.zeros_like(pc1_transformed[:, 0], dtype=np.int32)
        return pc1_transformed, pc2_transformed, pc1_norm, pc2_norm, sf_transformed, self.samples[index], voxel_list
