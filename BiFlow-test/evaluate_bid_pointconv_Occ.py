"""
To evaluate models trained on occluded FlyingThings3D.
...
def main():
    ...
    for _ in range(num_test):
        for i, data in tqdm(enumerate(val_loader, 0), total=len(val_loader), smoothing=0.9):
            pos1, pos2, norm1, norm2, flow, mask1, path, _ = data
            ...
            EPE3D, acc3d_strict, acc3d_relax, outlier = evaluate_3d(pred_sf, sf_np, mask1)
