"""
Borrowed from Bi-pointﬂownet: Bidirectional learning for point cloud based scene ﬂow estimation (ECCV'2022).

In our work, we apply our self-supervised learning method to BiFlow model.

Reference:
BiFlow: https://github.com/cwc1260/BiFlow/blob/new1/pointconv_util.py
"""
